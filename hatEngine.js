// src/services/hatEngine.js

// ── Hat Badge Definitions ─────────────────────────────
const HATS = [
...
/**
 * Hitung activity score (0–100) dari metrik akun X
 *
 * Bobot komponen:
 *   30% — follower authority  (log-scaled)
 *   25% — tweet volume        (log-scaled)
 *   25% — engagement rate
 *   20% — account longevity   (tahun aktif)
 */
function calcActivityScore({ followersCount, tweetCount, engagementRate, joinedAt }) {
  // Follower authority (0–30)
